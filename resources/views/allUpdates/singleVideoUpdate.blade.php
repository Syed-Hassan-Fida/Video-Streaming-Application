        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mt-4">
                        <h1>Update Home Main Previews Info</h1>
                        <form method="post" action="{{ route('home-single-video-edit') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Title</label>
                                <input type="text" name="title" value="{{ $homeVideos->title }}" class="form-control" id="exampleInputPassword1" required>
                            </div>
                            ...
                            <input type="hidden" name="home_id" value="{{ $homeVideos->id }}">
                    ...
                    <div class="mt-4">
                        ...
                        <form method="post" action="{{ route('home-single-info-edit') }}" enctype="multipart/form-data">
                            ...
                            @if(sizeof($HomeVideoInfo) > 0)
                                @foreach ($HomeVideoInfo as $key => $HomeVideoInfoItem)
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Col{{$key+1}}</label>
                                        <input type="text" name="col1[]" value="{{ $HomeVideoInfoItem->col1}}" class="form-control" id="exampleInputPassword1" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Col{{$key+1}}</label>
                                        <input type="text" name="col2[]" value="{{ $HomeVideoInfoItem->col2}}" class="form-control" id="exampleInputPassword1" required>
                                    </div>

                                    <input type="hidden" name="home_info_id[]" value="{{ $HomeVideoInfoItem->id }}">
                                    @php
                                        $home_info_id = $HomeVideoInfoItem->id;
                                    @endphp
                            ...
                            <input type="hidden" name="home_video_id" value="{{$home_video_id}}">
