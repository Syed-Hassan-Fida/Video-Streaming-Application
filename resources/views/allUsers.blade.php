            ...
            @if(Auth::user()->user_role == "admin")
                <li class="nav-item">
                    ...
                    <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Data</h6>
                            <a class="collapse-item" href="{{route('all-users')}}">All Users</a>
                            {{-- <a class="collapse-item" href="cards.html">Cards</a> --}}
                        </div>
                    </div>
                </li>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route("resgister-user") }}" method="post">
                                    @csrf
                                    <label>Name</label>
                            ...
                            @if($allUsers)
                                @foreach($allUsers as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('edit-user', ['id'=>$item->id]) }}" style="color: green; text-decoration: none;">Edit</a>
                                            <a href="{{ route('delete-user', ['id'=>$item->id]) }}" style="color: red; text-decoration: none;">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
