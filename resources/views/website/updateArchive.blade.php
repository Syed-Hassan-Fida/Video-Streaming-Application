        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mt-4">
                        ...
                        <form method="post" action="{{ route('updateArchives') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="year" value="{{ $archives->year }}" class="form-control" id="exampleInputPassword1" >
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">client</label>
                                <input type="text" name="client" value="{{ $archives->client }}" class="form-control" id="exampleInputPassword1" >
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Agency</label>
                                <input type="text" name="project" value="{{ $archives->project }}" class="form-control" id="exampleInputPassword1" >
                            </div>
                            ...
                            {{-- <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Title</label>
                                <input type="text" name="title" value="" class="form-control" id="exampleInputPassword1" >
                            </div> --}}
                    ...
                    <!--            <input type="file" name="gif" value="{{ asset("gif/".$archives->gif) }}" class="form-control" id="exampleInputPassword1" >-->
                    <!--        </div>-->
