                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <button class="btn" style="background-color: #fe3d30; color: white;"
                                ...
                                <button id="rowAdder1" type="button"
                                    class="btn" style="background-color: #0055FB; color: white;">
